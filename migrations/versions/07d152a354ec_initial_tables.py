...
Revision ID: 07d152a354ec
Revises: 
Create Date: 2026-04-19 14:50:56.195195
...
def upgrade():
    ...
    with op.batch_alter_table('news', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_news_source'), ['source'], unique=False)
...
def downgrade():
    ...
    op.drop_table('users')
    with op.batch_alter_table('news', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_news_source'))
